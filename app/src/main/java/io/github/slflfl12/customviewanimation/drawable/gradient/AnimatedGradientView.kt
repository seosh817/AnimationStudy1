...
open class AnimatedGradientView @JvmOverloads constructor(
    ...
    private val drawable = GradientDrawable(GradientDrawable.Orientation.BR_TL, colors.take(2).toIntArray())

    private val animator: Animator = createGradientAnimator(drawable)
    ...
    private fun createGradientAnimator(gradientDrawable: GradientDrawable): Animator {
        val max = colors.size
